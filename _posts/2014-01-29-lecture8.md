...
**Simulating from a Poisson process:** Assume the space $\Omega$ has finite measure $\mu(\Omega)$, otherwise break it down into a partition with finite measure blocks. 
